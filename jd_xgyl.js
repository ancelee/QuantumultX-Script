...
async function xgyl() {
  ...
  $.beans = 0
  for (let i = 0; i < 20; ++i) {
    await getMissionList().catch((err) => {
        console.log(err)
    })
    await $.wait(1000)
  }
...
function taskUrl(function_id, body) {
  return {
    ...
    headers: {
      ...
      'jexpress-trace-id': 'c1991b08-de53-419f-adc5-6e9e5f41dce9',
      'x-requested-with': 'XMLHttpRequest',
      'source-client': '2',
      'appparams': '{"appid":158,"ticket_type":"m"}',
      'version': '1.0.0',
      'origin': 'https://jingcai-h5.jd.com',
      'referer': 'https://jingcai-h5.jd.com/?lng=104.063451&lat=30.717296&sid=437f701b73fadc090036b76efea0996w&un_area=22_1930_50946_52194',
      'accept-language': 'zh-CN',
      'event-id': '1fbaf883-f9aa-4794-8047-43029cba981a',
      "Cookie": cookie,
      "User-Agent": "jdapp;iPhone;9.5.0;14.4.2;a0e355e3e8f251ad16247126328943df313934dc;network/wifi;supportApplePay/0;hasUPPay/0;hasOCPay/0;model/iPhone13,3;addressid/9745598;supportBestPay/0;appBuild/167638;jdSupportDarkMode/0;Mozilla/5.0 (iPhone; CPU iPhone OS 14_4_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1",
    }
  }
}
